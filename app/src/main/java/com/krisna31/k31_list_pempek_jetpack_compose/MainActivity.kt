...
import com.krisna31.k31_list_pempek_jetpack_compose.pages.DetailPempekPages
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                val id = it.arguments?.getInt("pempekId") ?: 1
                DetailPempekPages(
                    pempekId = id,
                    onBackClick = {
...
fun AboutPages(modifier: Modifier = Modifier) {
    Column(
        ...
        Text("Jelvin Krisna Putra", style = MaterialTheme.typography.headlineMedium.copy(
            fontWeight = FontWeight.Bold,
        ))
        Text("krisnaaaputraaa@gmail.com", style = MaterialTheme.typography.headlineMedium.copy(
